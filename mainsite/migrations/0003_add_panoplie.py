...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.panoplie'
        db.add_column(u'mainsite_item', 'panoplie',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mainsite.Panoplie'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Item.panoplie'
        db.delete_column(u'mainsite_item', 'panoplie_id')
