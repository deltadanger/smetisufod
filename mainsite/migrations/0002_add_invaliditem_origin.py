...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InvalidItem.origin'
        db.add_column(u'mainsite_invaliditem', 'origin',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InvalidItem.origin'
        db.delete_column(u'mainsite_invaliditem', 'origin')
