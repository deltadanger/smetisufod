...
SECRET_KEY = '**89d861^1u(zx0u%&yk@4o%ah)+)#b5d70zhoxy)%yt2+81fc'
...
MIDDLEWARE_CLASSES = (
    ...
    "smetisufod.middlewares.CorsMiddleware",
)

ROOT_URLCONF = 'smetisufod.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'smetisufod.wsgi.application'
...
DOFUS_COOKIES = "LANG=fr; SID=8F065BA510C1A36E09AEDFB7EE2A0001"
